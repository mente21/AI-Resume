...
const TempletSelector = ({ selectedTemplate, onChange }) => {
    ...
    return (
        <div className="relative">
            <button
                ...
                bg-gradient-to-br from-blue-50 to-blue-100 ring-blue-300
            ...
            {isOpen && (
                <div
                    className="absolute top-full w-64 p-3 mt-2 space-y-3 z-10 bg-white
...
export default TempletSelector;
