...
import TempletSelector from '../components/TempletSelector'
...
const ResumeBuilder = () => {
    ...
    // FIX: load when resumeId changes
    useEffect(() => {
    ...
    const saveResume = async () => {
        try {
            ...
            const img = updatedResumeData.personal_info?.image
                                ...
                                {resumeData.public && (
                                    <button
                                        ...
                                        className='flex items-center p-2 px-4 gap-2 text-xs
                                            ...
                                            rounded-lg ring ring-blue-300 hover:ring transition-colors'
                                    >
