...
const Dashboard = () => {
    ...
    const colors = ["#933eea", "#d97706", "#dc2626", "#0284c7", "#16a34a"]
            ...
            <div className='max-w-7xl mx-auto px-4 py-8'>
                ...
                <div className='flex gap-4'>
                    <button
                        ...
                        border-slate-300 group hover:border-indigo-600 hover:shadow-lg transition-all 
                    ...
                    <button
                        ...
                        className='w-full bg-white sm:max-w-36 h-48 flex flex-col items-center 
                        justify-center rounded-lg gap-2 text-slate-600 border border-dashed 
                        border-slate-300 group hover:border-purple-600 hover:shadow-lg transition-all 
                        duration-300 cursor-pointer'
                    >
